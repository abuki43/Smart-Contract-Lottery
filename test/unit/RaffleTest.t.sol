...
contract RaffleTest is Test {
    ...
    function testPerformUpkeepUpdatesRaffleStateAndEmitsRequestId() raffleEntered public {
    ...
    modifier skipFork() {
     ...
     function testFulfillRandomWordsCanOnlyBeCalledAfterPerformUpkeep(uint256 randomNumber) public raffleEntered skipFork {
        // Arrange
        // Act / Assert
